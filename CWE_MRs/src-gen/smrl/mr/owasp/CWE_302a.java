...
public class CWE_302a extends MR{
  public boolean mr() {
    ...
    for (final Action action : _actions) {
      {
        ...
        {
          ifThenBlock();
          if (((Operations.isLogin(action) && Operations.EQUAL(Operations.Input(2), Operations.Input(1))) && Operations.Input(2).actions().get(action.getPosition()).setCookiePath(Operations.RandomCookiePath()))) {
            ifThenBlock();
